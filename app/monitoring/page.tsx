...
export default function MonitoringPage() {
  ...
  const chartData = entries.map((entry) => {
    ...
    return { label: `${date} · Gudang ${entry.warehouse} · ${entry.shift}`, operatorCount: entry.operatorCount, date, shift: entry.shift, warehouse: entry.warehouse };
  });
