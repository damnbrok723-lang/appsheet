...
export default function MonitoringPage() {
  ...
  const chartData = entries.map((entry) => {
    const date = new Date(entry.date).toLocaleDateString("id-ID", { day: "2-digit", month: "2-digit" });
